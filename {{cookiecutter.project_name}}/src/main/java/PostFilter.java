...
public class $$POSTFILTER_CLASS_NAME extends ExtendedQueryBase implements PostFilter {
    ...
    public $$POSTFILTER_CLASS_NAME(String field, FieldType fieldType, Sort sort) {
        this.field = field;
    ...
    public boolean equals(Object o) {
        if (!(o instanceof $$POSTFILTER_CLASS_NAME)) {
            return false;
        }
        $$POSTFILTER_CLASS_NAME that = ($$POSTFILTER_CLASS_NAME) o;
